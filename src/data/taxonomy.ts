...
export const industries = [
  { title: 'Construction', href: '/industries/construction-cpa-services/', image: '/images/industries/construction.jpg', desc: 'Given all of the moving parts involved, our ability to manage the specific accounting and tax complexities makes us an invaluable asset to your budget.' },
  { title: 'Family Office', href: '/industries/family-office-accounting-services/', image: '/images/industries/family-office.jpg', desc: 'As families look to safeguard their assets for future generations, they need someone they can depend on.' },
  { title: 'Healthcare', href: '/industries/healthcare-accounting-services/', image: '/images/industries/healthcare.jpg', desc: 'We navigate the tax complexities associated with the industry and minimize their tax expense by using all of the available deductions.' },
  { title: 'High Net Worth', href: '/industries/high-net-worth-accounting-cpa/', image: '/images/industries/high-net-worth.jpg', desc: 'We help our high net-worth clients analyze their entity structures and various types of taxable income to strategically minimize the taxable impact.' },
  { title: 'Law Firms', href: '/industries/law-firm-accounting-services/', image: '/images/industries/law-firms.jpg', desc: 'Professional service firms, including law firms, turn to Alpine Mar for a full-service, outsourced accounting function and ongoing tax advice.' },
  { title: 'Marketing Agencies', href: '/industries/marketing-agency-accounting-services/', image: '/images/industries/marketing-agencies.jpg', desc: 'Creative service providers, trust Alpine Mar to provide a comprehensive suite of services, including financial management and strategic guidance.' },
  { title: 'Real Estate', href: '/industries/real-estate-cpa-services/', image: '/images/industries/real-estate.jpg', desc: 'We help plan for each transaction, understand all available deferral options, and maximize each year’s deductions.' },
  { title: 'Sports & Athletes', href: '/industries/sports-accounting-services/', image: '/images/industries/sports-athletes.jpg', desc: 'From professional and collegiate athletes to performers at packed concert venues, our clients spend their time sharing their talents.' },
  { title: 'Crypto', href: '/industries/crypto-cpa-services/', image: '/images/industries/crypto.jpg', desc: 'Individuals and businesses that trade in digital assets rely on our team for compliant reporting and tax optimization.' },
  { title: 'SaaS', href: '/industries/saas-accounting-services/', image: '/images/industries/saas.jpg', desc: 'We help SaaS companies with accurate revenue recognition, cash flow management, key metrics, and tax compliance.' },
  { title: 'Startups', href: '/industries/startup-cpa-services/', image: '/images/industries/startups.jpg', desc: 'We provide essential financial management, strategic planning, and accounting expertise to support early-stage and high-growth companies.' },
] as const;
