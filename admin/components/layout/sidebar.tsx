...
const navGroups: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/navigation', label: 'Navigation', icon: ListTree, title: 'Services & Industries mega-menu' },
...
const itNavGroups: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/it/navigation', label: 'Navigation', icon: ListTree, title: 'IT Services mega-menu' },
